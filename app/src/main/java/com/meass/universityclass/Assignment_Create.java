...
public class Assignment_Create extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assignment__create);
        try {
        ...
        loginnn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(username.getText().toString())||TextUtils.isEmpty(usernam2e.getText().toString())||
                    ...
                    AlertDialog.Builder builder=new AlertDialog.Builder(Assignment_Create.this);
                    builder.setTitle("Confirmation")
                            .setMessage("Are  you want to create this assignment?")
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            final KProgressHUD progressDialog = KProgressHUD.create(Assignment_Create.this)
