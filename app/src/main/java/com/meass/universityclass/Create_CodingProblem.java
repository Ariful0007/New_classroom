...
public class Create_CodingProblem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create__coding_problem);
        ...
        loginnn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(username.getText().toString())||TextUtils.isEmpty(usernam2e.getText().toString())||
                    ...
                    AlertDialog.Builder builder=new AlertDialog.Builder(Create_CodingProblem.this);
                    builder.setTitle("Confirmation")
                            .setMessage("Do you want to post this code?")
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            final KProgressHUD progressDialog = KProgressHUD.create(Create_CodingProblem.this)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                Toasty.success(getApplicationContext(),"Successfully Posting",Toasty.LENGTH_SHORT,true).show();

                                                //name, section, roomid, class_,uuid
                                                Intent intent=new Intent(getApplicationContext(),Coding_Home.class);
