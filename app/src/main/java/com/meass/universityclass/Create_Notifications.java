...
public class Create_Notifications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create__notifications);
        try {
        ...
        toolbar.setTitle("Create Notification");
        ...
        loginnn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(username.getText().toString())||TextUtils.isEmpty(usernam2e.getText().toString())||
                    ...
                    AlertDialog.Builder builder=new AlertDialog.Builder(Create_Notifications.this);
                    builder.setTitle("Confirmation")
                            .setMessage("Are  you want to create this notification?")
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            final KProgressHUD progressDialog = KProgressHUD.create(Create_Notifications.this)
                                    .setStyle(KProgressHUD.Style.SPIN_INDETERMINATE)
                                    .setLabel("Creating Notification.....")
