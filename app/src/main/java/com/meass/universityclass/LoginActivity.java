        ...
        login_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(text1) || TextUtils.isEmpty(tet2)) {
                    ...
                    if (edtemail.getText().toString().length() < 11) {
                        Toasty.info(getApplicationContext(), "Enter a valid number.", Toast.LENGTH_SHORT, true).show();
                        return;
                    } else {
                                                ...
                                                firebaseAuth.signInWithEmailAndPassword(text1.toLowerCase() + "@gmail.com", "123456").addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            firebaseAuth.signOut();
                                                            progressDialog.dismiss();
                                                            Toasty.error(LoginActivity.this, "Couldn't Log In. Please check your Phone Number/Password", 2000).show();
                                                        }
                                                    }
                                                });
