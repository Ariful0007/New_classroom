...
public class MyClassPeople extends AppCompatActivity {
    LottieAnimationView empty_cart;
    DocumentReference documentReference;
    RecyclerView recyclerView;
    PeopleAdapter getDataAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_class_people);
        FirebaseApp.initializeApp(MyClassPeople.this);
        try {
        ...
        getDataAdapter1 = new PeopleAdapter(getList,"as");
        firebaseFirestore = FirebaseFirestore.getInstance();
        documentReference =     firebaseFirestore.collection("PeopleList")
                .document(roomid)
                .collection("List")
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyClassPeople.this));
