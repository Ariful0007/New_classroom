...
public class MyExamAnswer extends AppCompatActivity {
    LottieAnimationView empty_cart;
    DocumentReference documentReference;
    RecyclerView recyclerView;
    AnswerAdapter__Exam getDataAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(MyExamAnswer.this);
        try {
        ...
        getDataAdapter1 = new AnswerAdapter__Exam(getList,"as");
        firebaseFirestore = FirebaseFirestore.getInstance();
        documentReference =     firebaseFirestore.collection("My_ExamAnswer")
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyExamAnswer.this));
