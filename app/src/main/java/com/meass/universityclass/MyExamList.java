...
public class MyExamList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(MyExamList.this);
        try {
        ...
        getDataAdapter1 = new MyExamAdapter(getList,"as",name, section, roomid, class_,uuid);
        firebaseFirestore = FirebaseFirestore.getInstance();
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyExamList.this));
