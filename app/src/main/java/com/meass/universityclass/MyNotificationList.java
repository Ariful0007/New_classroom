...
public class MyNotificationList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(MyNotificationList.this);
        try {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyNotificationList.this));
