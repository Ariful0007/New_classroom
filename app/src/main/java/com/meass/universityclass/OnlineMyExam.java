...
public class OnlineMyExam extends AppCompatActivity {
    LottieAnimationView empty_cart;
    DocumentReference documentReference;
    RecyclerView recyclerView;
    MyExamAdapter__2 getDataAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_online_my_exam);
        FirebaseApp.initializeApp(OnlineMyExam.this);
        try {
        ...
        getDataAdapter1 = new MyExamAdapter__2(getList,"as");
        firebaseFirestore = FirebaseFirestore.getInstance();
        documentReference =     firebaseFirestore.collection("Exam")
                .document("list").
                        collection(roomid)
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(OnlineMyExam.this));
